...
if not data.raw["lab"]["lab"].fast_replaceable_group then
    ...
    data.raw["lab"]["lab-mk3"].fast_replaceable_group = data.raw["lab"]["lab"].fast_replaceable_group
end
...
if not data.raw["radar"]["radar"].fast_replaceable_group then
    ...
    data.raw["radar"]["radar-mk2"].fast_replaceable_group = data.raw["radar"]["radar"].fast_replaceable_group
end
